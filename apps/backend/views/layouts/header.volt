    ...
    <head>
       ...
       folder instead of downloading all of them to reduce the load. -->
        {{ stylesheet_link("public/backend/dist/css/skins/_all-skins.min.css") }}
         <!-- DataTables -->
         {{ stylesheet_link("public/backend/plugins/datatables/dataTables.bootstrap.css") }}
    </head>
    <body class="sidebar-mini skin-red">
	<!-- header logo: style can be found in header.less -->
	<header class="main-header">
		<!-- Logo -->
		<a href="{{ url('admin') }}" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown user user-menu">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> 
							<img src="{{url('backend/dist/img/avatar3.png')}}" class="user-image"
							alt="User Image"> 
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								<img src="{{url('backend/dist/img/avatar3.png')}}" class="img-circle" alt="User Image">
